...
<template>
  ...
  <div>
    <div class="border border-primary p-2">Query ID: {{ props.query.queryId }}</div>
    <br />
  ...
  <button @click="show_fields = !show_fields" class="mx-2 btn btn-secondary">
    Toggle Field Names
  </button>
  <button @click="show_timestamps = !show_timestamps" class="mx-2 btn btn-secondary">
    Toggle Timestamps
  </button>
  <button @click="show_query = !show_query" class="mx-2 btn btn-secondary">
